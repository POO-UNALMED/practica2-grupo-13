 ...
 * necesarios para el formulario específico de la funcionalidad *Fertilizar e
 * irrigar*, puesta en el menú de funcionalidades proporcionadas por le programa
 *
 */
public class BuildFertilizarIrrigar {
	...
	/**
	 * Metodo que construye toda la vista necesaria para Fertilizar e irrigar
	 * 
